...
učenje skupa s redukcijama u strojnom učenju \engl{reductions in machine
learning} omogućava dobre teoretske garancije metoda učenja pretraživanja.
...
jednostavniji problem na združeno učenje i predviđanje \engl{joint learning and
prediction}. Naposljetku, glavni razlog široke primjene je vrlo jednostavna
...
Tri različita zadatka: \begin{inlinelist} \item označavanje vrste riječi, \item
ovisnosno parsanje i \item združeno označavanje i parsanje. Uz tri osnovna
zadatka prisutne su njihove varijante i različiti pristupi na istom problemu.
