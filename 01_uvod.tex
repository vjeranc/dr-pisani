...
dobru \bq{policu}{Dobar prijevod (strategija, politika) sve su ženski rod pa se lako ctrl+h zamjene -- \emph{policy}?}.
...
učenje i redukcije u strojnom učenju \engl{machine learning reductions}
