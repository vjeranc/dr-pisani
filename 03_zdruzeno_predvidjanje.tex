...
Ako postoji prikladan $\mathcal{Y}$ i prikladna funkcija značajki $\mathbf{\Phi}$ onda se
...
pronalaženje dobrih rješenja. Recimo, ako $\mathbf{\Phi}$ ima takvu dekompoziciju preko
