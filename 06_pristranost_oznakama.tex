...
vektori značajki $\mathbf{\Phi}$ su reprezentacija stanja i opažanja pomoću koje bi
...
$\mathbf{w} \cdot \mathbf{\Phi} = 0$ -- potrebno je napraviti nasumičan odabir. Ako je odabran $A$, onda će u drugom koraku biti odabran $E$ i gubitak će
