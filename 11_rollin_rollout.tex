...
\textit{rollin} politiku. Sivi čvorovi se ne pretražuju. U koraku $R$ algoritam
učenja odabire sve moguće odluke radeći odstupanje od jednog koraka i
primjenjuje \textit{rollout} politiku za svaku moguću odluku dovoljno puta dok ne
...
brdom \engl{local hill climbing}, naučena politika biti konstantno lošija od dane
...
pretjerano korisna ako je referentna politika jako loša, u tom slučaju učenje se
